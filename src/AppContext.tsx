...
import {
	IBoardMember,
	BoardPositions
} from './Components/StaffPage/types/BoardMember';
...
const dummyMenuOptionData: IMenuOption[] = [
	{ link: '/roster/men', label: 'Men' },
	{ link: '/roster/women', label: 'Women' },
	{ link: '/staff', label: 'Staff' },
	{ link: '/records', label: 'Records' },
	{ link: '/blog', label: 'Blog' }
];
const dummyMenuData: IMenu[] = [
	{ label: 'About', options: dummyMenuOptionData }
];
const dummyAthleteData: IMemberInfo[] = [
	{
		...
		lastName: 'McNamara',
		image:
			'http://www.grcrunning.com/uploads/5/6/0/9/5609246/published/18083892-10212902692826133-104163445-o.jpg?1516842187',
		gender: 'women'
	},
	{
		id: 2,
		firstName: 'Taylor',
		lastName: 'Tubbs',
		image: 'http://www.grcrunning.com/uploads/5/6/0/9/5609246/tay_orig.jpg',
		gender: 'women'
	},
	{
		id: 3,
		firstName: 'Stephanie',
		lastName: 'Reich',
		image: 'http://www.grcrunning.com/uploads/5/6/0/9/5609246/2620708.jpg',
		gender: 'women'
	},
	{
		id: 4,
		...
		lastName: 'Bollerman',
		image:
			'http://www.grcrunning.com/uploads/5/6/0/9/5609246/chelsea-clarendonday_orig.jpg',
		gender: 'women'
	},
	{
		id: 5,
		...
		lastName: 'Burton',
		image:
			'http://www.grcrunning.com/uploads/5/6/0/9/5609246/published/jordan-10.png?1563288479',
		gender: 'men'
	}
];
const dummyAthleteMap: { [key: string]: IAthleteBio } = {};
dummyAthleteData.forEach(
	a =>
		(dummyAthleteMap[`${a.id}`] = {
			id: a.id,
			firstName: a.firstName,
			lastName: a.lastName,
			bio: 'This is a bio about the athlete with id',
			prList: ['800,1:50', 'Mile,4:04.18'],
			image: a.image,
			instagram: 'taylortubbs',
			twitter: 'jordyburton3',
			email: 'jordieburton3@gmail.com'
		})
);
const dummyBoardInfoList: IBoardMember[] = [
	{ id: 5, position: BoardPositions.MensDirector },
	{ id: 2, position: BoardPositions.President }
];
...
const records: IClubRecord[] = [
	...
	},
	{
		athleteId: 4,
		event: 'Marathon',
		time: convertToMilliseconds({ hours: 2, minutes: 42, seconds: 1.0 }),
		yearSet: 2013,
		gender: 'women',
		venue: 'road'
	}
...
export class GrcApp extends React.PureComponent<
	IGrcAppContextProps,
	IGrcAppContextState
> {
...
const getAthleteList = (context: IAppContext, gender: string) =>
	context.state.athleteList.filter(a => a.gender === gender);
const getBoardMembers = (context: IAppContext) =>
	context.state.athleteList.filter(a => dummyBoardInfo[a.id]);
