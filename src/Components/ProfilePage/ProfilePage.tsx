...
const ProfilePage: React.FunctionComponent<IProfilePageProps> = props => {
	...
	const hasSocialMedia =
		athleteBio.instagram || athleteBio.email || athleteBio.twitter;
	return (
			...
			<div className="profile-page__content-wrapper">
				...
				<div className="profile-page__social-media-wrapper">
					...
					{athleteBio.instagram && (
						<a
							className="profile-page__handle-wrapper"
							href={`https://instagram.com/${athleteBio.instagram}`}
						>
							<InstagramIcon />
							<span className="profile-page__social-media-text standard-text standard-text">
								@{athleteBio.instagram}
							</span>
						</a>
					)}
					{athleteBio.twitter && (
						<a
							className="profile-page__handle-wrapper"
							href={`https://twitter.com/${athleteBio.twitter}`}
						>
							<TwitterIcon />
							<span className="profile-page__social-media-text standard-text">
								@{athleteBio.twitter}
							</span>
						</a>
					)}
...
export const ConnectedProfilePage: React.FunctionComponent<
	IConnectedProfilePageProps
> = props => {
	...
	return (
		<AppContext.Consumer>
			{context => {
				...
				return (
					<ProfilePage
						athleteBio={context.state.athleteMap[`${athleteIdAsInt}`]}
					/>
				);
			}}
		</AppContext.Consumer>
